...
const file_proto_greeter_proto_rawDesc = "" +
	...
	"\x05count\x18\x02 \x01(\x05R\x05count2\x92\x01\n" +
	"\aGreeter\x12;\n" +
	"\bSayHello\x12\x15.greeter.HelloRequest\x1a\x16.greeter.HelloResponse\"\x00\x12J\n" +
	"\x15SayHelloMultipleTimes\x12\x15.greeter.HelloRequest\x1a\x16.greeter.HelloResponse\"\x000\x01B\x11Z\x0fgrpc-demo/protob\x06proto3"
...
var file_proto_greeter_proto_depIdxs = []int32{
	...
	0, // 1: greeter.Greeter.SayHelloMultipleTimes:input_type -> greeter.HelloRequest
	1, // 2: greeter.Greeter.SayHello:output_type -> greeter.HelloResponse
	1, // 3: greeter.Greeter.SayHelloMultipleTimes:output_type -> greeter.HelloResponse
